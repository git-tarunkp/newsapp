...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const getArticles = async () => {
      const response = await axios.get('https://newsdata.io/api/1/news?apikey=pub_35493a04c74d2a2553389c2205bddad0c51b1&q=sports%20news&country=in&language=en&category=education,other,politics ')
  ...
  const fetchData=(value)=>{
    fetch("https://newsdata.io/api/1/news?apikey=pub_35493a04c74d2a2553389c2205bddad0c51b1&q=sports%20news&country=in&language=en&category=education,other,politics ")
        ...
        <section className="py-2 header text-center ">
          <div className="container py-5 text-black " >
            <header className="py-5">
              <h1 className="display-4" style={{display:"inline"}}>"question mar kya laga rhi ho khud ne hi promise diya hai na pehle promise wapas lo to reply karoon na" </h1>
            ...
            <div className="container-fluid all-show">
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li className="nav-item">
                    <a className="nav-link" style={{background:"Highlight", borderRadius:"10px"}} href="/">Home</a>
                  </li>
                  <li className="nav-item">
