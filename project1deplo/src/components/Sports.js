...
const Sports = () => {
  ...
  const fetchData=(value)=>{
    fetch("https://newsdata.io/api/1/news?apikey=pub_35493a04c74d2a2553389c2205bddad0c51b1&q=sports%20news&country=in&language=en&category=sports")
  ...
  return (
    <div id='news'>
      <section className="py-5 header text-center ">
            ...
            <div className="container-fluid all-show">
              ...
              <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li className="nav-item">
                  ...
                  <li className="nav-item ">
                    <a className="nav-link" style={{background:"Highlight", borderRadius:"10px"}} href={`/sports`}>Sports</a>
                  </li>
        ...
        <form class="row domain-search bg-pblues">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
